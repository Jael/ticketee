Feature: Creating Tickets
  ...
  Scenario: Creating a ticket with an attachment
    ...
    And I press "Create Ticket"
    Then I should see "Ticket has been created."
    Then I should see the "speed.txt" within "#ticket .assets"
    Then I should see the "spin.txt" within "#ticket .assets"
    Then I should see the "gradient.txt" within "#ticket .assets"
